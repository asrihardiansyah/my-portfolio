...
const Navbar = () => {
  ...
  return (<div className="navbar py-7 flex items-center justify-between">
    ...
    <ul 
    className={`menu flex items-center sm:gap-5 gap-2 md:static left-1/2 -translate-x-1/2 fixed md:translate-x-0
    ...
    >
     ...
     <li>
        <a href="#pengalaman" className="sm:text-lg text-base font-medium">Pengalaman</a>
      </li>
       <li>
